  ...
  return (
    <div className="min-h-screen bg-netflix-black">
      ...
      <div className="sticky top-16 z-30 bg-netflix-black/95 backdrop-blur-xl border-b border-white/10 shadow-xl">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-6 overflow-x-auto scrollbar-hide max-w-screen-2xl">
      ...
      {/* Main Content */}
      <div className="mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-20 lg:py-32 max-w-screen-2xl">
        <div className="w-full">
